function myAlert(str,click,useCancel){
    ...
    var init=function(){
        ...
        var $okBtn = $("<div style='float:left;width:100%;color:#eee;border-radius:5px;padding:7px 0;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;background-color:#333' class='bluebg1'>确定</div>")
